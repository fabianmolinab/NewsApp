...
export const CardBlog = () => {
  return (
    <ContenedorCard>
      <ImgBlog src="https://images.unsplash.com/photo-1593642533144-3d62aa4783ec?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" />
...
const ContenedorCard = styled.div`
  ...
  &:hover {
    transform: translate3d(0px, 0px, 0px) scale3d(1.02, 1.02, 1) rotateX(0deg)
      rotateY(0deg) rotateZ(0deg) skew(0deg);
    transform-style: preserve-3d;
    border-radius: 16px;
    //background-color: #fff;
    box-shadow: 0 0 72px 36px rgba(0, 0, 0, 0.08);
  }
`
